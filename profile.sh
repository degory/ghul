...
find lib compiler driver ioc system logging source lexical syntax semantic llvm ir -name '*.ghul' | xargs valgrind --tool=callgrind $GHUL -D -P ghul -G -X -o ghul imports.l source/*.l
