...
Pass-specific files live in a folder named after the pass they serve (`compile-expressions/`, `generate-il/`, …); files used by more than one pass, or by the IDE tooling, live at the top level.
